...
const IndustrySpecialization = () => {
  return (
    <div className="text-center space-y-12 px-4 lg:px-20">
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6'>
        ...
        <div className='relative w-full h-[200px] md:h-[250px] xl:h-[300px]'>
          <img src={education} alt="Education Technology" className='h-full w-full object-cover rounded-xl' />
          <div className='absolute bottom-0 w-full bg-black bg-opacity-60 text-center py-2 rounded-b-xl'>
