...
//         <nav>
//     <h6 className="normal-case font-bold text-2xl flex justify-center items-center gap-2"><FaUsersLine className='mt-1' size={25}/>About Us</h6>
//     <div className="divider divider-success w-[170px] m-0 -mt-2 " ></div>

//    <p>Welcome to CybeRefresh, where innovation meets transformation, and the future of technology unfolds. <br /> At CybeRefresh, we are more than just consultants; we are architects of change, <br /> navigating the realms of technology to empower businesses across diverse industries.</p>
//   </nav>
...
import React from 'react';
import { RiEdit2Fill } from "react-icons/ri";
import { FaHandshake, FaUsersLine } from "react-icons/fa6";
import { IoCallOutline } from "react-icons/io5";

const Footer = () => {
  return (
    <div>
      <footer className="footer flex flex-col md:flex-row justify-between px-4 md:px-32 bg-tertiary text-white p-10">
        <nav className="mb-6 md:mb-0">
          ...
          <p className="text-sm w-fit lg:w-[400px]">
            Welcome to CybeRefresh, where innovation meets transformation, and the future  of technology unfolds. 
             At CybeRefresh, we are more than just consultants; we are  architects of change, 
             navigating the realms of technology to empower  businesses across  diverse industries.
          </p>
        </nav>
        ...
        <nav className="mb-6 md:mb-0">
          ...
          <a className="link link-hover hover:text-primary text-sm">Is Cloud the Right Choice?</a>
          <a className="link link-hover hover:text-primary text-sm">Information Security</a>
          <a className="link link-hover hover:text-primary text-sm">Fostering Growth Through Technology Consultation</a>
          <a className="link link-hover hover:text-primary text-sm">Unleashing Digital Potential</a>
        </nav>
        ...
        <nav>
          ...
          <a className="link link-hover hover:text-primary text-sm">Hyderabad | Telangana | India</a>
          <a className="link link-hover hover:text-primary text-sm">Email: info@cyberefresh.com</a>
          <a className="link link-hover hover:text-primary text-sm">Website: www.cyberefresh.com</a>
          <a className='link link-hover flex justify-center items-center gap-2 text-sm' href="">
            <div className='bg-primary rounded-full p-3'>
              <IoCallOutline size={20} />
            </div>
            <p> Call us on <br />
      ...
      <footer className="footer bg-tertiary text-white px-4 md:px-10 py-4">
        <aside className="grid-flow-col items-center">
